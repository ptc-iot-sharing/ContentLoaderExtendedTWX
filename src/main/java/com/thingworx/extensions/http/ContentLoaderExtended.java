        ...
        try {
            ...
            if (!StringUtilities.isNullOrEmpty(repository) && !StringUtilities.isNullOrEmpty(repository)) {
                ...
                try {
                    ...
                    entityBuilder.addBinaryBody(multipartFileName, inputStream, contentType, fileName);
